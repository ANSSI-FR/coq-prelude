...
Class PropBool1
      ...
      (pred:       A -> Prop)
      (pred_bool:  A -> bool) :=
  { pred_bool_pred_1 (a:  A)
    : pred_bool a = true <-> pred a
  }.

Lemma pred_bool_false_1
      {A:          Type}
      (pred:       A -> Prop)
      (pred_bool:  A -> bool) `{PropBool1 A pred pred_bool}
      (a:          A)
...
Lemma pred_bool_false_2
      ...
      {B:          Type}
      (pred:       A -> B -> Prop)
      (pred_bool:  A -> B -> bool) `{PropBool2 A B pred pred_bool}
      (a:          A)
      (b:          B)
...
Lemma pred_bool_false_3
      ...
      {C:          Type}
      (pred:       A -> B -> C -> Prop)
      (pred_bool:  A -> B -> C -> bool) `{PropBool3 A B C pred pred_bool}
      (a:          A)
      (b:          B)
      (c:          C)
